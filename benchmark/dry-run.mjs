...
function dryRun(key = process.argv[2] || "clc") {
  ...
  console.log(
    color
      .red(
        `a red ${color.white("white")} red ${color.red("red")} red ${color.gray("gray")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.blue("blue")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")}red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")}red ${color.green("green")} red ${color.red("red")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.magenta("red")} red ${color.red("red")}red ${color.red(
          "red"
        )} red ${color.cyan("cyan")} red ${color.red("red")} red ${color.red("red")} red ${color.yellow("yellow")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} red ${color.blue("blue")} red ${color.red("red")} red ${color.red(
          "red"
        )} red ${color.red("red")} red ${color.red("red")} message`
      )
      .toString()
  );
}
...
if (process.argv.slice(2).includes('--all')) {
  Object.keys(libs).forEach(d => dryRun(d));
} else dryRun();
